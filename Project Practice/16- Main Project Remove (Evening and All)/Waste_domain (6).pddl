(define (domain Waste_domain)
  ...
  (:action Move_Person_To_CityBin
      ...
      :precondition (and(related ?who ?person_capacity)(related ?who ?OldBag)(related ?who ?bin)(person_hands_full ?person_capacity)(related ?cityBin ?bin)(have_oldBag ?OldBag)(is_loc ?who ?from)(is_loc ?cityBin ?to))
  ...
  (:action Load_Organic_City_Garbage
    :parameters (?truck - Truck ?cityBin - CityBin ?from ?to - location)
    :precondition (and(related ?truck ?cityBin)(is_loc ?truck ?from)(is_loc ?cityBin ?to))
  ...
  (:action UnLoad_Organic_City_Garbage
    :parameters (?truck - Truck  ?dumpyard - Dumpyard ?from ?to - location)
    :precondition (and(related ?dumpyard ?truck)(is_loc ?truck ?from)(is_loc ?dumpyard ?to)(collected_cityBins_garbage ?truck))
