(define (problem Waste_problem)
  ...
  (:objects
    ...
    Garbage_O_1 Garbage_PL_1 Garbage_PA_1 - garbageSubstance
  ...
  (:init
   ...
   (is_loc Garbage_PL_1 R1)
   (is_loc Garbage_PA_1 R1)
  ...
  (:goal
    (and 
    	 ...
    	 (garbage_in_bin Garbage_PL_1 PL_Bin_1)
    	 
    	 (disposed_cityBins_garbage truck_PL)
    	 
    	 (garbage_in_bin Garbage_PA_1 PA_Bin_1)
