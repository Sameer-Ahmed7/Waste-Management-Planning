(define (problem Waste_problem)
  ...
  (:objects
    ...
    NewBag_Plastic_1 NewBag_Organic_1  NewBag_2 - newBag
    OldBag_Plastic_1 OldBag_Organic_1 OldBag_2 - oldBag
    room_1 room_2 - Room
    
    
    ;; Assign Truck, Time and Dumpyard
    truck_plastic truck_organic - Truck
    time - Time
    dumpyard_plastic dumpyard_organic - Dumpyard
    
    
    n0 n1 n2 n3 n4 n5 n6 n7 n8 n9
    n10 n11 n12 n13 n14 n15 n16 n17 n18 n19
    n20 n21 n22 n23 n24 - quantity
  ...
  (:init
    ...
    (is_loc NewBag_Organic_1 pos_5)
    (is_loc NewBag_Plastic_1 pos_5)
   ...
   (is_loc organic_2 pos_15)
    ...
    ;;(is_loc truck_plastic pos_20)
    ;;(is_loc dumpyard_plastic pos_20)
    ...
    ; Platic and organic Bags
    (related organic_bin_1 NewBag_Organic_1)
    (related plastic_bin_1 NewBag_Plastic_1)
    
    
    (related organic_bin_1 OldBag_Organic_1)
    (related plastic_bin_1 OldBag_Plastic_1)
    ...
    (related truck_plastic plastic_city_Bin_1)
    (related dumpyard_plastic truck_plastic)
    ...
    (related organic_bin_2 NewBag_2)
    ;(related plastic_bin_2 NewBag_Plastic_1)
    
    
    (related organic_bin_2 OldBag_2)
    ;(related plastic_bin_1 OldBag_Plastic_1)
    ...
    ;; Starting Truck Limit 
    (Truck_capacity truck_organic n2)
    (Truck_capacity  truck_plastic n2)
    
    
    ;; Capacity Increase
    ;(plus1  truck_organic n1 n2)
    ;(plus1 truck_organic n2 n3)
    ;(plus1 truck_organic n3 n4)
    ;(plus1 truck_organic n4 n5)
    ;(plus1 truck_organic n5 n6)
    ...
    (between truck_organic n0 n1)
    
    
    (between truck_plastic n1 n2)
    
    
    
    
    
    (= (distance pos_21 pos_21) 0) ; Dumpyard
    (= (distance pos_9 pos_9) 0) ; Organic City Bin 1
    (= (distance pos_18 pos_18) 0) ; Organic City Bin 2
    
    (= (distance pos_21 pos_18) 10) ; Dumpyard to Organic City Bin 2
    (= (distance pos_18 pos_9) 10) ; Organic City Bin 2 to Organic City Bin 1
    (= (distance pos_9 pos_21) 10) ; Organic City Bin 1 to Dumpyard
    
    (= (distance pos_21 pos_9) 20) ; Dumpyard to Organic City Bin 1
    (= (distance pos_9 pos_18) 20) ; Organic City Bin 1 to Organic City Bin 2
    (= (distance pos_18 pos_21) 20) ; Organic City Bin 2 to Dumpyard
    
    
    (= (per_km_cost truck_organic) 3)
  ...
  (:goal
    (and 
    	 ...
    	 ;(garbage_in_bin plastic_1 plastic_bin_1)
    	 
    	 ;(disposed_cityBins_garbage truck_plastic)
