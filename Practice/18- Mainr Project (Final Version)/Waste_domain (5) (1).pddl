(define (domain Waste_domain)
  ...
  (:action Get_New_Bag
     ...
     :precondition (and(related ?who ?person_capacity)(related ?who ?bin)(related ?bin ?NewBag)(person_hands_empty ?person_capacity)(bin_full ?bin)(is_loc ?who ?from)(is_loc ?NewBag ?to))
