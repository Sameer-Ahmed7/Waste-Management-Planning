...
(:action Move_To_Room
:parameters(?person ?room ?substance ?from ?to)
:precondition (and(is_person ?person)(Room ?room)(not(have_substance ?substance))(substance_bag ?substance)(not(is_loc ?person ?to))(is_loc ?person ?from)(is_loc ?substance ?to)(is_loc ?room ?to))
...
:precondition (and(is_person ?person)(have_substance ?substance)(substance_bag ?substance)(bin_clear ?bin)(is_loc ?person ?pos)(is_loc ?bin ?pos))
...
:parameters(?person ?bin ?substance ?pos)
:precondition (and(is_person ?person)(have_substance ?substance)(substance_bag ?substance)(bin_half ?bin)(is_loc ?person ?pos)(is_loc ?bin ?pos))
:effect(and(not(have_substance ?substance))(not(bin_half ?bin))(bin_full ?bin)(substance_in_bin ?substance ?bin)))
