...
:precondition (and(is_person ?person)(have_substance ?substance)(Bin ?bin)(is_loc ?person ?from)(is_loc ?bin ?to))
...
:precondition (and(is_person ?person)(Bin ?bin)(substance_in_bin ?substance ?bin)(is_loc ?person ?to)(is_loc ?bin ?to))
...
:precondition (and(is_person ?person)(Room ?room)(not(is_loc ?person ?to))(is_loc ?person ?from)(is_loc ?substance ?to)(is_loc ?room ?to))
